...
public class ConfirmationTimeFilter implements Filter {
    ...
    public ConfirmationTimeFilter(final String detectorType,
    ...
    private boolean confirmation(final boolean isFlaky, final String verifyType,
        ...
        final boolean confirmed = verifyTime(verifyType, dependentTest, absoluteRound);
    ...
    private boolean verifyTime(final String verifyType, final DependentTest dependentTest, final int absoluteRound) {
        return dependentTest.verifyTime(runner, DetectorPathManager.filterPath(detectorType, verifyType, absoluteRound));
    }
}
