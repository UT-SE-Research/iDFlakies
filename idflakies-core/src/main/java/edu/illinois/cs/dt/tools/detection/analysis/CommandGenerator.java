...
//                sqlite.statement(SQLStatements.PROBABILITY_FIND_FLAKY_NO_ORIGINAL)));
        ...
        final int numNOTestOrig =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("NO").param("original"));
        final int numNOTestRandClassMethod =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("NO").param("random"));
        final int numNOTestRandClass =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("NO").param("random-class"));
        final int numNOTestReverse =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("NO").param("reverse"));
        final int numNOTestReverseClass =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("NO").param("reverse-class"));
        ...
        final int numODTestReverse =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("OD").param("reverse"));
        final int numODTestReverseClass =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("OD").param("reverse-class"));
        final int numODTestRandClassMethod =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("OD").param("random"));
        final int numODTestRandClass =
            query(sqlite.statement(SQLStatements.COUNT_TESTS_BY_ROUND_TYPE).param("OD").param("random-class"));
        ...
        // System.out.println(command("numFlakyTestRandClassMethod", String.valueOf(numODTestRandClassMethod
        //     + numNOTestRandClassMethod)));
        ...
        // System.out.println(command("numFlakyTestReverseClass", String.valueOf(numODTestReverseClass
        //     + numNOTestReverseClass)));
    ...
    private String commandQuery(final String commandName, final String postStr,
